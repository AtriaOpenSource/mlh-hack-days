  ...
  return (
    <div className="space-y-16 pb-24 pt-8">
      ...
      <section id="timeline" className="relative mt-16">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-[120px_1fr] gap-8 md:gap-12 mb-10 pl-8 md:pl-0">
          ...
          <div className="bg-bg border border-structural p-8 shadow-sm hover:shadow-struct hover:-translate-y-1 hover:-translate-x-1 transition-all border-l-4 border-l-ink">
            ...
            <div className="mt-4 flex gap-2">
              <span className="font-mono text-[10px] bg-ink/5 text-ink px-2 py-1 uppercase">
                Lobby
              </span>
            </div>
          </div>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-[120px_1fr] gap-8 md:gap-12 mb-10 pl-8 md:pl-0">
          ...
          <div className="bg-ink border-thick text-bg p-8 shadow-struct relative overflow-hidden">
            ...
            <p className="font-sans text-sm text-bg/70 relative z-10">
              Hacking starts. Build your projects and get support from mentors
              on the floor. Runs until 5:00 PM.
            </p>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-[120px_1fr] gap-8 md:gap-12 mb-10 pl-8 md:pl-0">
          <div className="absolute left-[10px] md:left-[138px] top-2 w-3.5 h-3.5 bg-indigo border-2 border-bg rounded-full z-10 shadow-[0_0_10px_rgba(79,70,229,0.3)]"></div>
          <div className="font-mono text-sm font-bold text-indigo md:text-right pt-1">
            01:00 PM - 02:00 PM
          </div>
          <div className="bg-gradient-to-br from-[#F5F3FF] to-[#FFF7ED] border-2 border-indigo/20 p-8 shadow-sm hover:shadow-struct hover:-translate-y-1 transition-all relative overflow-hidden flex flex-col md:flex-row justify-between items-center gap-8 group">
            <div className="relative z-10 flex-grow text-left">
              <div className="flex items-center gap-3 mb-3">
                <span className="font-mono text-[10px] text-indigo tracking-[0.2em] font-bold uppercase">
                  Featured Session
                </span>
              </div>

              <h3 className="font-display text-2xl md:text-3xl font-bold uppercase mb-3 text-ink">
                ChatGPT Lab <span className="text-indigo">by OpenAI</span>
              </h3>

              <p className="font-sans text-sm md:text-base text-neutral/80 max-w-xl mb-6">
                ChatGPT Lab for Students is a peer-to-peer, show-and-tell style
        ...
        {/* Quiz 2 removed per schedule update */}
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-[120px_1fr] gap-8 md:gap-12 mb-10 pl-8 md:pl-0">
          ...
          <div className="bg-bg border-thick border-indigo p-8 shadow-struct hover:-translate-y-1 hover:-translate-x-1 transition-all relative overflow-hidden">
            ...
            <p className="font-sans text-sm text-neutral">
              Demo round and evaluation by judges. Performance analysis and
              final review of all projects.
            </p>
            <div className="mt-4 flex gap-2">
              <span className="w-2 h-2 bg-indigo rounded-full animate-pulse"></span>
              <span className="font-mono text-[9px] text-indigo uppercase font-bold">
                Judging in Progress
              </span>
            </div>
          </div>
