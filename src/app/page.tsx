    ...
    <div className="space-y-24 pb-24">
      ...
      <section id="briefing" className="pt-0">
        ...
        <div className="relative w-full h-[65vh] min-h-[500px] md:h-[75vh] md:min-h-[650px] flex items-center justify-center mb-12 overflow-hidden">
          ...
          <div className="absolute top-4 right-4 md:top-8 md:right-8 z-20 pointer-events-none text-right">
            <h1 className="font-display font-bold text-5xl sm:text-7xl md:text-9xl lg:text-[11rem] leading-none tracking-tighter uppercase text-transparent" style={{ WebkitTextStroke: "1.5px #1e1b4b" }}>
              Code
            </h1>
          </div>
      ...
      <section className="pt-16 relative">
        <div className="flex flex-col mb-12">
          ...
          <p className="text-neutral font-sans max-w-lg">
            Deploy your ideas into scalable infrastructure. We focus on modern cloud native engineering, low latency compute, and intelligent systems.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { icon: Terminal, title: "Cloud Native", desc: "Build resilient, auto-scaling architectures using advanced AWS services." },
            { icon: Cpu, title: "Edge Compute", desc: "Develop high-performance solutions that process data closer to the source." },
            { icon: Shield, title: "Security", desc: "Architect secure systems, implement protocols, and build resistant applications." },
            { icon: Zap, title: "AI/ML", desc: "Deploy sophisticated models into production-ready pipelines and interfaces." },
          ].map((track, i) => (
            <div key={i} className="p-8 bg-white flex flex-col h-full group relative overflow-hidden">
              ...
              <h3 className="text-lg font-mono mb-3 text-ink font-bold">{track.title}</h3>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {[
          ...
          { label: "Prizes", val: "TBA" },
          { label: "Capacity", val: "125+" },
          { label: "Status", val: "LIVE" },
        ].map((stat, i) => (
          <div key={i} className="p-8 flex flex-col items-center justify-center text-center bg-white hover:bg-ink/[0.02] transition-colors relative group">
      ...
      <section className="p-12 md:p-20 bg-ink text-bg relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-start md:items-center text-left md:text-center max-w-3xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="font-mono text-xs tracking-widest text-neutral">FINAL DIRECTIVE</span>
          </div>
          <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tight mb-6 uppercase">
            Ready to <span className="text-transparent" style={{ WebkitTextStroke: "1px #faf9f6" }}>Deploy?</span>
          </h2>
          <p className="text-lg font-sans text-bg/70 mb-10 text-balance">
            Join elite student engineers building the next generation of scalable infrastructure and intelligent systems. Registration is open for a limited time.
          </p>
          <Link
            href="https://events.mlh.io/events/13939-hack-days-by-atria-summer-of-code"
            target="_blank"
